...
from osu_dreamer.audio_encoder.data.module import Data
from osu_dreamer.audio_encoder.model import Model

file_option_type = click.Path(exists=True, dir_okay=False)

default_config_path = './osu_dreamer/audio_encoder/model.yml'
...
def fit_audio_encoder(config: str, ckpt_path: Optional[str]):
    """begin a training run for the audio encoder model"""
